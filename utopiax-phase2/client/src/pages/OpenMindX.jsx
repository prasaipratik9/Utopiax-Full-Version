    ...
    <div>
      ...
      <section className="px-6 py-16">
        <div className="mx-auto max-w-3xl space-y-6 font-body text-lg leading-relaxed text-gray-700">
          ...
          <blockquote className="rounded-2xl border-l-4 border-brand-rose bg-gray-50 p-6 font-display text-xl italic text-brand-maroon shadow-[0_8px_30px_rgba(255,100,82,0.08)]">
